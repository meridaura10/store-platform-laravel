...
namespace App\Livewire\Admin\Models\Order;
...
use App\Livewire\Datatables\Utils\Actions\ActionShow;
...
class Index extends Table
{
    ...
    {
        $builder->with('payment', 'moderation');
    }
    ...
    {
        redirect()->route('admin.order.moderation', $order);
    }

    public function actionEdit(Order $order)
    {
        redirect()->route('admin.order.edit', $order);
    }
}
