    ...
    <div class="auth-wrap h-screen flex flex-col items-center justify-center bg-gray-100">
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="flex flex-col mb-6">
                        ...
                        <div class="relative">
                            ...
                            <input placeholder="Enter your password" id="password" type="password" name="password"
                                class="text-sm placeholder-gray-500 pl-10 pr-4 rounded-2xl border border-gray-400 w-full py-2 focus:outline-none focus:border-blue-400" />
                        </div>
                    </div>
        ...
        >
            <span class="ml-2">
                ...
                <a href="{{ route('register') }}" class="text-xs ml-2 text-blue-500 font-semibold">register here</a>
            </span>
        </a>
    </div>
    </div>
